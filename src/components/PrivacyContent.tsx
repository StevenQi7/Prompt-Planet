...
export default function PrivacyContent() {
  ...
  const getPrivacyKey = (section: typeof sections[number], type: 'title' | 'content') => {
    return `privacy.sections.${section}.${type}` as const;
  };
      ...
      <div className="relative mb-8 bg-gradient-to-r from-indigo-600 to-purple-600">
        <div className="container mx-auto px-4 py-12 relative z-10">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-lg text-gray-100">{t('privacy.lastUpdated')}</p>
          </div>
        </div>
            ...
            {sections.map((section) => (
              <section key={section} id={section} className="mb-12 last:mb-0">
                ...
                <p className="text-gray-700 leading-relaxed">
                  {t(getPrivacyKey(section, 'content'))}
                </p>
              </section>
            ))}
          </div>
